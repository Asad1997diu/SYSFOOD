...
class AppStyle{
  ...
  static TextStyle Title = GoogleFonts.nunito(fontSize: 16.0, fontWeight: FontWeight.normal,color: Colors.black);
  static TextStyle dateTitle = GoogleFonts.roboto(fontSize: 13.0, fontWeight: FontWeight.w500,color: Colors.black);
